loc1 = './datasets/group23/linearly_separable/class1_train.txt';
loc2 = './datasets/group23/linearly_separable/class2_train.txt';
loc3 = './datasets/group23/linearly_separable/class3_train.txt';
loc4 = './datasets/group23/linearly_separable/class4_train.txt';
...
g_cov_mat = finding_same_cov_mat_for_Bayes(cov1,cov2,cov3,cov4,d,n_c);

% Constructing the discriminants

 g1 = calculate_g_of_x(data,mu_1,g_cov_mat,P_c1);
 g2 = calculate_g_of_x(data,mu_2,g_cov_mat,P_c2);
 g3 = calculate_g_of_x(data,mu_3,g_cov_mat,P_c3);
 g4 = calculate_g_of_x(data,mu_4,g_cov_mat,P_c4);

% Assigning class labels to trained data

g_star = zeros(size,1);
g_labels = zeros(size,1); 
...
[X1,X2] = meshgrid(-15:.1:20, -15:.1:20);
 ...
 g_t1 = calculate_g_of_x(X,mu_1,g_cov_mat,P_c1);
 g_t2 = calculate_g_of_x(X,mu_2,g_cov_mat,P_c2);
 g_t3 = calculate_g_of_x(X,mu_3,g_cov_mat,P_c3);
 g_t4 = calculate_g_of_x(X,mu_4,g_cov_mat,P_c4);
...
%%% Separating out data for plotting
 ...
 xlabel('x1');
 ylabel('x2');
 title('Decision region prediction for 4-class Bayes classifier on Training data (Linearly separable data)');
...
loct1 = './datasets/group23/linearly_separable/class1_test.txt';
loct2 = './datasets/group23/linearly_separable/class2_test.txt';
loct3 = './datasets/group23/linearly_separable/class3_test.txt';
loct4 = './datasets/group23/linearly_separable/class4_test.txt';
...
%%% Calculate gi's for each value of xi's
 ...
 g_test1 = calculate_g_of_x(data_t,mu_1,g_cov_mat,P_c1);
 g_test2 = calculate_g_of_x(data_t,mu_2,g_cov_mat,P_c2);
 g_test3 = calculate_g_of_x(data_t,mu_3,g_cov_mat,P_c3);
 g_test4 = calculate_g_of_x(data_t,mu_4,g_cov_mat,P_c4);
...
locv1 = './datasets/group23/linearly_separable/class1_val.txt';
locv2 = './datasets/group23/linearly_separable/class2_val.txt';
locv3 = './datasets/group23/linearly_separable/class3_val.txt';
locv4 = './datasets/group23/linearly_separable/class4_val.txt';
...
g_val1 = calculate_g_of_x(data_v,mu_1,g_cov_mat,P_c1);
g_val2 = calculate_g_of_x(data_v,mu_2,g_cov_mat,P_c2);
g_val3 = calculate_g_of_x(data_v,mu_3,g_cov_mat,P_c3);
g_val4 = calculate_g_of_x(data_v,mu_4,g_cov_mat,P_c4);
