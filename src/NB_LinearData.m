...
figure;
gscatter(data(:,1),data(:,2),labels,'rygb');
xlabel('x1');
ylabel('x2');
...
% Calculating global varinces of all classes
 ...
 gv = (gv1 + gv2 + gv3 + gv4)/n_c;
% Constructing the discriminants

 g1 = calculate_g_of_x(data,mu_1,gv,P_c1);
 g2 = calculate_g_of_x(data,mu_2,gv,P_c2);
 g3 = calculate_g_of_x(data,mu_3,gv,P_c3);
 g4 = calculate_g_of_x(data,mu_4,gv,P_c4);
...
[X1,X2] = meshgrid(-15:.1:20, -15:.1:20);
 ...
 g_t1 = calculate_g_of_x(X,mu_1,gv,P_c1);
 g_t2 = calculate_g_of_x(X,mu_2,gv,P_c2);
 g_t3 = calculate_g_of_x(X,mu_3,gv,P_c3);
 g_t4 = calculate_g_of_x(X,mu_4,gv,P_c4);
...
% % Calculate gi's for each value of xi's
 ...
 g_test1 = calculate_g_of_x(data_t,mu_1,gv,P_c1);
 g_test2 = calculate_g_of_x(data_t,mu_2,gv,P_c2);
 g_test3 = calculate_g_of_x(data_t,mu_3,gv,P_c3);
 g_test4 = calculate_g_of_x(data_t,mu_4,gv,P_c4);
...
g_val1 = calculate_g_of_x(data_v,mu_1,gv,P_c1);
g_val2 = calculate_g_of_x(data_v,mu_2,gv,P_c2);
g_val3 = calculate_g_of_x(data_v,mu_3,gv,P_c3);
g_val4 = calculate_g_of_x(data_v,mu_4,gv,P_c4);
