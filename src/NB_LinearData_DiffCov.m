...
c3 = get_diag_cov(cov3,d);
c4 = get_diag_cov(cov4,d);
...
% Constructing the discriminants
 ...
 g3 = calculate_g_of_x(data,mu_3,c3,P_c3);
 g4 = calculate_g_of_x(data,mu_4,c4,P_c4);
...
[X1,X2] = meshgrid(-15:.1:20, -15:.1:20);
 ...
 g_t3 = calculate_g_of_x(X,mu_3,c3,P_c3);
 g_t4 = calculate_g_of_x(X,mu_4,c4,P_c4);
...
% % Calculate gi's for each value of xi's
 ...
 g_test3 = calculate_g_of_x(data_t,mu_3,c3,P_c3);
 g_test4 = calculate_g_of_x(data_t,mu_4,c4,P_c4);
...
g_val3 = calculate_g_of_x(data_v,mu_3,c3,P_c3);
g_val4 = calculate_g_of_x(data_v,mu_4,c4,P_c4);
