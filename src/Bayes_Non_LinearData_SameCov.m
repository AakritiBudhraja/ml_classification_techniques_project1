...
loc3 = './datasets/group23/nonlinearly_separable/class3_train.txt';
loc4 = './datasets/group23/nonlinearly_separable/class4_train.txt';
...
% figure;
% gscatter(data(:,1),data(:,2),labels,'rb','od');
% xlabel('x1');
% ylabel('x2');
...
%  % Separating out data for plotting
 ...
 xlabel('x1');
 ylabel('x2');
title('Decision region prediction for 2-class Bayes classifier on Training data (Non-linearly separable data)');
