...
g_cov_mat = finding_same_cov_mat(cov1,cov2,cov3,cov4,d,n_c);
...
%  % Separating out data for plotting
 ...
 xlabel('x1');
 ylabel('x2');
 title('Decision region prediction for 4-class Naive Bayes classifier on Training data (Linearly separable data)');
